...
(function () {
  ...
  const I18N = {
    ar: {
      ...
      region_basis_inv: "الأساس: فواتير العملاء المرحّلة (INV) حسب تاريخ الفاتورة، بقيمها شاملة الضريبة. المحافظة = حقل «الولاية» في بطاقة العميل بأودو كما هو. 🔍 للمطابقة: المحاسبة ← الفواتير — تصفية «تاريخ الفاتورة» + «مرحّلة»، ثم التجميع حسب «العميل ← الولاية» (عمود الإجمالي).",
    ...
    en: {
      ...
      region_basis_inv: "Basis: posted customer invoices (INV) by invoice date, tax-inclusive totals. Governorate = the customer's State field in Odoo verbatim. 🔍 Verify: Accounting → Invoices — filter Invoice Date + Posted, group by Customer → State (Total column).",
