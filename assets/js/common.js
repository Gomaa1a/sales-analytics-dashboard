...
(function () {
  ...
  const I18N = {
    ar: {
      ...
      region_basis_inv: "الأساس: فواتير العملاء المرحّلة حسب تاريخ الفاتورة، بقيمها شاملة الضريبة. «الإجمالي» = الفواتير فقط · «الصافي» = بعد خصم إشعارات الدائن (المرتجعات) — وهو ما يطابق شاشة أودو «الفواتير» المجمّعة حسب الولاية. المحافظة = حقل «الولاية» في بطاقة العميل كما هو.",
      col_gross: "الإجمالي",
      col_net: "الصافي (بعد المرتجعات)",
    ...
    en: {
      ...
      region_basis_inv: "Basis: posted customer invoices by invoice date, tax-inclusive. \"Gross\" = invoices only · \"Net\" = after credit notes (returns) — which matches Odoo's Invoices screen grouped by State. Governorate = the customer's State field verbatim.",
      col_gross: "Gross",
      col_net: "Net (after returns)",
